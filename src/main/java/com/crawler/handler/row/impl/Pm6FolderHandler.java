...
//		String imgName = FolderUtil.filterFolderName(url.substring(url.lastIndexOf("/")+1 ) ) ;  //图片名
		...
		imgName =  NumberUtil.autoNumber()+"-"+imgName;
		//没有后缀,默认使用png
		
		String fullPath =path+ File.separator+product.getList().get(2)+imgName  ;   //颜色+随机码
