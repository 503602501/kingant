 ...
 * 具体的行处理类
 */
public class PermitPdfHandler implements IRowHander {
...
/*	@Override
	...
	public static void main(String[] args) {
		PermitPdfHandler folderHandler  = new PermitPdfHandler();
	...
	public String handerRow(Product product,Environment env) {
		String path  = env.getDownloadPath()+"download";
		...
		String fullpath = path+File.separator+product.getList().get(12)+".pdf";
		return fullpath;
	}
