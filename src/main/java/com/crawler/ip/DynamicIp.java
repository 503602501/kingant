...
public class DynamicIp {
    private DynamicIp(){}
    private static final Logger LOGGER =  Logger.getLogger(DynamicIp.class);
//    Logger LOGGER = LoggerFactory.getLogger(DynamicIp.class);
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String password = "13535242305";
    	String routerLoginUrl = "http://192.168.0.1/login_pc.htm";  //路由器的登录地址
    	InputStream in = FolderUtil.getInputStreamFromEncrypt("log4j.properties");
		PropertyConfigurator.configure(in);
		
        toNewIp(username,password,routerLoginUrl);
    }
     ...
     * @return 更改IP是否成功
     */
    public static boolean toNewIp(String username , String password,String routerLoginUrl) {
        ...
        Map<String, String> cookies = login(username,password, routerLoginUrl,"phonenumber***");
    ...
    public static Map<String, String> login(String userName, String password,String url,String verify){
        try {
            Map<String, String> map = new HashMap<>();
