 ...
 * 降价
 */
public class TaobaoZtPricecHandler implements IText {
	...
	public String getText(String text,WebElement web,WebDriver webDriver,TextUnit textUnit,Storage storage) {
		...
		try {
			...
			webDriver.findElement(By.xpath("//table/thead/tr/th[3]/div/div/span")).click(); 
			Thread.sleep(1500);
			webDriver.findElement(By.xpath("//div[@class='thead-title']/div/ul[@class='dropdown-list']/li/span[contains(text(),'核心')]")).click();
			Thread.sleep(2000);
			
			/**********低于10的展现数取消标蓝**************/
			webDriver.findElement(By.xpath("//div[contains(text(),'展现量')]")).click();  
			Thread.sleep(2000);
			...
			for (int i = 0; i < del.size(); i++) {
				webDriver.findElement(By.xpath("//table[@class='bp-table']/tbody/tr[@id]["+del.get(i)+"]/td[1]")).click();
				Thread.sleep(300);
			}
			...
			if(del.size()!=0){
				webDriver.findElement(By.xpath("//span[text()='标签']")).click();
				Thread.sleep(1500);
				webDriver.findElement(By.xpath("//div[contains(@id,'addTagLayer')]/div[2]/input[@value=1]")).click();
				Thread.sleep(1500);
				webDriver.findElement(By.xpath("//span[text()='删除'][@style]")).click(); 
				Thread.sleep(2000);
			}
			...
			WebElement ee = webDriver.findElement(By.xpath("//div[@id='J_common_header']"));
			...
			Thread.sleep(1500);
			webDriver.findElement(By.xpath("//input[@class='checkall']")).click(); 
			//********************降价处理********************
			Thread.sleep(500);
